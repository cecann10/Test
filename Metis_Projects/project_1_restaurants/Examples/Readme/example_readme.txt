...
## Goal
Provide recommendations on how WTWY can optimize the placement of their Street teams in NYC subway stations, such that they can gather the most amount of signups.
...
**2. Cleaning data:** 
  - Fixing errors: We corrected xyz
  - Removing outliers: We removed entries that xyz
...
## Deliverable
- [EDA](link to notebook)
- [Python module](link to notebook)
- [Presentation Slide](link to notebook)


## Project Team
* [Member 1] (Link to github)
* [Member 2]( Link to github) 
* [Member 3]( Link to github)
